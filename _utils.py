...
class StokesRadiusCalculator:
    ...
    def stokes_einstein_radius(D,T,eta):
        ...
        Parameters:
        D (float): Diffusion coefficient (cm²/s) coming from the Wilke-Chang equation
...
@dataclass
class Solvents:
    water = Solvent("Water", 18.01528, 0.001, 2.6)
    methanol = Solvent("Methanol", 32.042, 0.0006, 1.9)
    ethanol = Solvent("Ethanol", 46.069, 0.0012, 1.5)
    other = Solvent("Other", None, None, 1.0)